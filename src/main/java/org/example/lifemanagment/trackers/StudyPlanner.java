...
public class StudyPlanner {
    ...
    static {
        ...
        collection = db.getCollection("study");
    }

    public static void display(String username) {
        Stage window = new Stage();
        window.setTitle("Study Planner - " + username);

        VBox layout = new VBox(10);

        Label label = new Label("Unesi predmet/aktivnost:");
        ...
        saveButton.setOnAction(e -> {
            ...
            if (!task.isEmpty()) {
                ...
                Alert alert = new Alert(Alert.AlertType.INFORMATION, "Study task saved!");
                alert.showAndWait();
            }
        });
        ...
        statsButton.setOnAction(e -> {
            ...
            int total = docs.size();
            String tasks = docs.stream()
                    .map(d -> d.getString("task"))
                    .collect(Collectors.joining(", "));
            statsLabel.setText("Total tasks: " + total + "\n" + tasks);
        });
